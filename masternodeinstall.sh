...
COIN_TGZP='https://github.com/Encocoin/xnk/releases/download/v3.0.0/encocoin-v3.0.0-linux.tar.gz'
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='encocoin'
PROJECT_NAME='Encocoin XNK - Encocoin Core'
...
function download_node() {
  ...
  wget -q $COIN_TGZP
  #compile_error
  tar zxvf $COIN_TGZ >/dev/null 2>&1
  mv encocoin/encocoin-cli .
  mv encocoin/encocoin-tx .
  mv encocoin/encocoind .
  rm -fr encocoin/
  #compile_error
  chmod +x $COIN_DAEMON
  chmod +x $COIN_CLI
...
addnode=167.86.103.113:43013
addnode=167.86.103.114:43013
addnode=173.249.5.205:43013
addnode=173.249.51.210:43013
addnode=164.68.102.158:43013
addnode=207.180.212.131:43013
addnode=164.68.112.213:43013
EOF
}
